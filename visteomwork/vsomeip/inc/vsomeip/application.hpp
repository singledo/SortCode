...
public:
    ...
    /**
	 *
	 * \brief This method tells whether or not this application act as performance
	 * measurement client
	 *
	 * The application perform loop back test by sending and receiving payload of
	 * different size.
	 *
	 * \return true, if this is performance measurement client.
	 * otherwise
	 *
	 */
    virtual bool is_performance_measurement_client() const = 0;
	 ...
	 * different size.
	 *
	 * \return true, if this is performance measurement server.
	 * otherwise
	 *
	 */
    virtual bool is_performance_measurement_server() const = 0;

    /**
   	 *
   	 * \brief This method return performance measurement interval
   	 *
  	 * \return interval in seconds
   	 *
   	 */
    virtual uint32_t get_performance_measurement_interval() const = 0;
